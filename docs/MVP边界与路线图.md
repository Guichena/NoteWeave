...
`一个统一工作区可以同时承载问答、Wiki 维护与资料调查三种工作模式，并通过 Deep Research 按钮与右侧产物按钮栏，把复杂任务沉淀为可追溯知识结果。`
...
`资料进入工作区 -> 用户在问答 / Wiki / 调查中消费资料 -> 用户通过 Deep Research 按钮或右侧产物按钮发起重型任务 -> 系统通过 Agent / Skill / MCP 能力栈生成可追溯结果 -> 结果经过确认回写为可沉淀知识。`
