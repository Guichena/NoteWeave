...
export const api = {
    ...
    personal: {
        ...
        listQuestions: (projectId) => request("/personal/research-questions", { query: { researchProjectId: projectId } }),
        createQuestion: (payload) => request("/personal/research-questions", { method: "POST", body: payload }),
        questionOverview: (questionId) => request(`/personal/research-questions/${questionId}/overview`),
        generateQuestionOverview: (questionId) => request(`/personal/research-questions/${questionId}/overview:generate`, { method: "POST" }),
        questionWorkspace: (questionId) => request(`/personal/research-questions/${questionId}/workspace`),
